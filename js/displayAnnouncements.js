...
const container = document.getElementById("student_main");

let url = `https://football-api-server-ane2c4bwdacvf8f6.eastus-01.azurewebsites.net/announcements/students?search=`;
...
async function searchAnnouncements() {
    ...
    let searchUrl = `https://football-api-server-ane2c4bwdacvf8f6.eastus-01.azurewebsites.net/announcements/students?search=${encodeURIComponent(
        search
    )}`;
