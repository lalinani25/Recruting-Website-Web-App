...
search_btn.addEventListener('click', async function (event) {
    ...
    async function searchStudents() {
        ...
        console.log(search)
        let url = `https://football-api-server-ane2c4bwdacvf8f6.eastus-01.azurewebsites.net/coachuser/studentusers?search=${search}`
        ...
        try {
            ...
            if (response.status == 200) {
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    messagebtn.className = "invitation_btn"
                    messagebtn.id = `invitation_btn${i}`
                    messagebtn.title = "Request contact information!"
                    messagebtn.textContent = "✉️"
                    console.log(messagebtn)
                    coach_info.appendChild(messagebtn)
                    ...
                    const invitation_btn = document.getElementById(`invitation_btn${i}`)
                    ...
                    invitation_btn.addEventListener('click', async function (event) {
                        ...
                        const url = "https://football-api-server-ane2c4bwdacvf8f6.eastus-01.azurewebsites.net/invitation";
                        console.log("test")
                        try {
