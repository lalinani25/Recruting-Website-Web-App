...
document.querySelector("#coach_login").addEventListener('click', async () => {
    console.log("login")

    const url = "https://football-api-server-ane2c4bwdacvf8f6.eastus-01.azurewebsites.net/coachuser/login"
    console.log(url)

    const email = document.querySelector("#coach_email")
    console.log(email.value)
    const password = document.querySelector("#coach_password")
